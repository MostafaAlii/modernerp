<div class="modal fade" id="createSalesMatrialTypeModal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ trans('dashboard/sales_matrial_type.create') }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>

            <form id="createSalesMatrialTypeForm" action="{{ route('admin.salesMatrialTypes.store') }}" method="POST">
                @csrf
                <div class="modal-body">
                    ...
                    <div class="mb-3 d-flex align-items-center justify-content-between">
                        <label class="form-label mb-0">{{ trans('dashboard/sales_matrial_type.is_active') }}</label>
