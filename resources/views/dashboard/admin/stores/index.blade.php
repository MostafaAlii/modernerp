...
<div class="page-content">
    <div class="content-header">
        <h1 class="mb-0">{{ trans('dashboard/store.stores') }}</h1>
        <ul class="breadcrumb">
            ...
            <li class="breadcrumb-item">
                <a href="{{ route('admin.stores.index') }}">{{
                    trans('dashboard/store.stores') }}</a>
            </li>
        </ul>
    </div>
    <!-- Start Content -->
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    @endphp
                    @include('dashboard.admin.stores.btn.create', compact('locales', 'currentLocale'))
                </div>
                <div class="card-body">
...
<script>
    window.translations = {
        ...
        window.routes = {
            update: "{{ route('admin.stores.update', ['store' => '__ID__']) }}",
            edit: "{{ route('admin.stores.edit', ['store' => '__ID__']) }}",
            destroy: "{{ route('admin.stores.destroy', ['store' => '__ID__']) }}",
        };
</script>
<script src="{{ asset('dashboard/assets/js/custom/utils/alert.js') }}"></script>
<script src="{{ asset('dashboard/assets/js/custom/admin/stores/index.js') }}"></script>
@endpush